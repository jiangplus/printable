...
var app = window.app = new Vue({
  ...
  data: {
    ...
    components: [{
      ...
      layers: [{
        ...
        visible: true,
        active: true,
        shapes: [{ type: 'rect-shape', id: createId(), radius: 30, x: 100, y: 100, width: 140, height: 160, selected: false, removed: false }, { type: 'circle-shape', id: createId(), x: 120, y: 130, width: 100, height: 100, selected: false, removed: false }]
      }, {
        name: 'layer-2',
        id: createId(),
        visible: true,
  ...
  created: function created() {
    ...
    onup.onValue(function (ev) {
      app.dragging = false;
    });

    ondown.onValue(function (ev) {
      app.dragging = true;
    ...
    ondown.filter(function (x) {
      ...
      if (app.view == 'component') {
        var activeLayer = _this.currentComponent.layers.find(function (x) {
          return x.active;
        });
    ...
    onmove.filter(function (ev) {
      return app.dragging && app.tool == 'rect' && app.obj;
    }).onValue(function (ev) {
      var shape = app.obj;
    ...
    onup.filter(function (ev) {
      return app.tool == 'rect' && app.obj;
    }).onValue(function (ev) {
    ...
    onmove.filter(function (ev) {
      return app.dragging && app.offsetX > app.viewBoxWidth + app.viewBoxX - 50;
    }).onValue(function (ev) {
      app.viewBoxX += 5;
    });

    onmove.filter(function (ev) {
      return app.dragging && app.offsetY > app.viewBoxHeight + app.viewBoxY - 50;
    }).onValue(function (ev) {
      app.viewBoxY += 5;
    });

    onmove.filter(function (ev) {
      return app.dragging && app.offsetX < 50 + app.viewBoxX;
    }).onValue(function (ev) {
      app.viewBoxX -= 5;
    });

    onmove.filter(function (ev) {
      return app.dragging && app.offsetY < 50 + app.viewBoxY;
    }).onValue(function (ev) {
      app.viewBoxY -= 5;
    });
    ...
    ondown.filter(function (ev) {
      return app.tool == 'zoomin';
    }).onValue(function (ev) {
    ...
    ondown.filter(function (ev) {
      ...
      app.obj = shape;
      if (app.view == 'component') {
        var activeLayer = app.currentComponent.layers.find(function (x) {
          return x.active;
        });
        activeLayer.shapes.push(shape);
      } else if (app.view == 'board') {
    ...
    onmove.filter(function (ev) {
      return app.dragging && app.tool == 'circle' && app.obj.id;
    }).onValue(function (ev) {
      var shape = app.obj;
    ...
    onup.filter(function (ev) {
      return app.tool == 'circle' && app.obj.id;
    }).onValue(function (ev) {
      if (app.obj.width < 0.01) {
        app.obj.removed = true;
        app.obj = {};
    ...
    onmove.filter(function (ev) {
      return app.dragging && app.tool == 'line' && app.obj.id;
    }).onValue(function (ev) {
      if (app.gridify) {
        app.offsetX = roundGrid(app.offsetX);
        app.offsetY = roundGrid(app.offsetY);
    ...
    onup.filter(function (ev) {
      return app.tool == 'line' && app.obj.id;
    }).onValue(function (ev) {
    ...
    ondown.filter(function (x) {
      return app.tool == 'select' && app.view == 'board';
    }).onValue(function (ev) {
      ...
      var target = parent_id ? _this.shapes.find(function (x) {
        return x.id == parent_id;
      }) : _this.shapes.find(function (x) {
      ...
      if (!target) {
        _this.clearSelect();
        _this.obj = null;
      } else if (target && _this.obj && _this.obj.id == target.id) {} else {
        _this.clearSelect();
    ...
    ondown.filter(function (x) {
      return app.tool == 'select' && app.view == 'component';
    }).onValue(function (ev) {
      var target_id = ev.target && ev.target.attributes['data-id'] && ev.target.attributes['data-id'].value;
      ...
      _this.currentComponent.layers.forEach(function (layer) {
    ...
    onmove.filter(function (ev) {
      return app.dragging && app.tool == 'measure';
    }).onValue(function (ev) {
      app.measurex2 = app.offsetX;
      app.measurey2 = app.offsetY;
    });
    ...
    onmove.filter(function (ev) {
      return app.dragging && app.tool == 'pan';
    }).onValue(function (ev) {
  ...
  methods: {
    setTool: function setTool(tool) {
      ...
      if (tool == 'zoomin') {} else if (tool == 'dumpSVG') {
        ...
        shapes_data.forEach(function (x) {
          ...
          fileField.addEventListener('change', function (x) {
            if (x.target.files.length > 0) {
              ...
              fileReader.onload = function (evt) {
                ...
                content.shapes.forEach(function (x) {
                  if (x.type == 'group-shape' && x.componentId) {
                    x.component = content.components.find(function (c) {
                      return c.id == x.componentId;
                    });
                  }
                });
        ...
        fileField.click();
        return;
      } else if (tool == 'zoomin') {} else if (tool == 'zoomout') {} else if (tool == 'zoom') {
        ...
        app.clearSelect();
      } else if (tool == 'component') {} else if (tool == 'collect') {
    ...
    clearSelect: function clearSelect() {
      ...
      if (app.view == 'board') {
        ...
        this.currentComponent.layers.forEach(function (layer) {
    ...
    switchComponentView: function switchComponentView() {
      this.clearSelect();
      this.obj = null;
      this.view = 'component';
    },
    switchBoardView: function switchBoardView() {
      this.clearSelect();
      this.obj = null;
      this.view = 'board';
    },
...
},{"baconjs":2,"firebase-auto-ids":4,"lodash":5,"vue":6}],2:[function(require,module,exports){
(function (global){
(function() {
